...
local plug_map = {
	--split
	["n|sg"] = map_cr(":split"):with_noremap():with_silent(),                       -- 打开上下窗口
	["n|sv"] = map_cr(":vsplit"):with_noremap():with_silent(),                      -- 打开左右窗口
	["n|<S-up>"] = map_cmd([[<C-w>+]]):with_noremap():with_silent(),               -- 全 选
	["n|<S-down>"] = map_cmd([[<C-w>-]]):with_noremap():with_silent(),               -- 全 选
	["n|<S-left>"] = map_cmd([[<C-w><]]):with_noremap():with_silent(),               -- 全 选
	["n|<S-right>"] = map_cmd([[<C-w>>]]):with_noremap():with_silent(),               -- 全 选
	["n|sc"] = map_cr(":close"):with_noremap():with_silent(),                       -- 关闭当前窗口
	["n|<C-j>"] = map_cmd("5j"):with_noremap():with_silent(),                       -- 向下5行
	["n|<C-k>"] = map_cmd("5k"):with_noremap():with_silent(),                       -- 向上5行
	["n|<C-s>"] = map_cr(":w"):with_noremap():with_silent(),                        -- 保 存
	["n|<S-a>"] = map_cmd([[gg<S-v>G]]):with_noremap():with_silent(),               -- 全 选
	["n|Q"] = map_cr(":q"):with_noremap():with_silent(),                            -- 退 出
	["n|R"] = map_cr(":source $MYVIMRC"):with_noremap():with_silent(),              -- 重新加载设置
	["n|L"] = map_cmd("$"):with_noremap():with_silent(),                            -- 行 首
	["n|H"] = map_cmd("^"):with_noremap():with_silent(),                            -- 行 尾
	["n|<space>"] = map_cmd(":"):with_noremap():with_silent(),                      -- 空 格代替:
	-- Bufferline
	["n|gb"] = map_cr("BufferLinePick"):with_noremap():with_silent(),
	["n|<space>j"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent(),    -- 右切换Tab
	["n|<space>k"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent(),    -- 左切换Tab
	["n|<S-j>"] = map_cr("BufferLineMoveNext"):with_noremap():with_silent(),        -- 右替换Tab
	["n|<S-k>"] = map_cr("BufferLineMovePrev"):with_noremap():with_silent(),        -- 左替换Tab
	-- ["n|<leader>be"] = map_cr("BufferLineSortByExtension"):with_noremap(),
	-- ["n|<leader>bd"] = map_cr("BufferLineSortByDirectory"):with_noremap(),
	["n|<space>1"] = map_cr("BufferLineGoToBuffer 1"):with_noremap():with_silent(), -- Tab1
	["n|<space>2"] = map_cr("BufferLineGoToBuffer 2"):with_noremap():with_silent(), -- Tab2
	["n|<space>3"] = map_cr("BufferLineGoToBuffer 3"):with_noremap():with_silent(), -- Tab3
	["n|<space>4"] = map_cr("BufferLineGoToBuffer 4"):with_noremap():with_silent(), -- Tab4
	["n|<space>5"] = map_cr("BufferLineGoToBuffer 5"):with_noremap():with_silent(), -- Tab5
	["n|<space>6"] = map_cr("BufferLineGoToBuffer 6"):with_noremap():with_silent(), -- Tab6
	["n|<space>7"] = map_cr("BufferLineGoToBuffer 7"):with_noremap():with_silent(), -- Tab7
	...
	["n|gr"] = map_cr("Lspsaga rename"):with_noremap():with_silent(),                  -- 重命名
	["n|K"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),                -- 浏览器文档
	["n|<space><Up>"] = map_cr("lua require('lspsaga.action').smart_scroll_with_saga(-1)"):with_noremap():with_silent(),  -- 向下翻页
	["n|<space><Down>"] = map_cr("lua require('lspsaga.action').smart_scroll_with_saga(1)"):with_noremap():with_silent(), -- 向下翻页
	["n|<space>ca"] = map_cr("Lspsaga code_action"):with_noremap():with_silent(),
	["v|<space>ca"] = map_cu("Lspsaga range_code_action"):with_noremap():with_silent(),
